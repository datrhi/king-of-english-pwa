...
export function Leaderboard({ show, players, progress }: LeaderboardProps) {
    return (
        <AnimatePresence>
            {show && (
                <motion.div
                            ...
                            {players.map((player, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <p
                                            className={`font-bold text-base ${player.isCurrentUser ? 'text-indigo-700' : 'text-gray-800'
                                                }`}
                                        >
                                            {player.name}
                                    ...
                                    {/* Score */}
                                    <div
                                        className={`text-right font-bold text-xl ${player.isCurrentUser ? 'text-indigo-700' : 'text-gray-700'
                                            }`}
                                    >
                                        {player.score}
